...
if(isset($_POST['btn_submit'])) {
    if(isset($_GET['editid'])) {
        ...
        if($qsql = mysqli_query($conn, $sql)) {
            ...
            echo "<script>setTimeout(\"location.href = 'appointment.php?patientid=$_POST[patient]';\",1500);</script>";
        } else {
            echo mysqli_error($conn);
        }
    }
...
<form id="main" method="post" action="" enctype="multipart/form-data">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <textarea class="form-control" name="reason" id="reason" required=""><?php if(isset($_GET['patid'])) echo $rsedit['app_reason']; ?></textarea>
            <span class="messages"></span>
        </div>
    </div>
